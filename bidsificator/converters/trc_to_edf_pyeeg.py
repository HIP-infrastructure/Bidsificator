...
class TrcToEdfConverterPyEEG(FormatConverter):
    ...
    def convert(self, source_path: Path, output_dir: Path = None) -> Path:
        ...
        try:
            ...
            raise RuntimeError(f"Failed to convert {source_path}: {e}") from e
    ...
    def _extract_hardware_filters(self, file_obj) -> dict[str, Any] | None:
    ...
    def _extract_reference_info(self, file_obj) -> str | None:
