...
class ConverterRegistry:
    ...
    def get_converter(self, file_path: Path, target_format: str = None) -> FormatConverter | None:
    ...
    def get_converter_by_name(self, converter_name: str) -> FormatConverter | None:
