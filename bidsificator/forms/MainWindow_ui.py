...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.taskGroupBox = QtWidgets.QGroupBox(parent=self.ImportSubjectsTab)
        self.taskGroupBox.setObjectName("taskGroupBox")
        self.taskHorizontalLayout = QtWidgets.QHBoxLayout(self.taskGroupBox)
        self.taskHorizontalLayout.setObjectName("taskHorizontalLayout")
        self.IS_TaskLabel = QtWidgets.QLabel(parent=self.taskGroupBox)
        self.IS_TaskLabel.setMinimumSize(QtCore.QSize(120, 0))
        self.IS_TaskLabel.setMaximumSize(QtCore.QSize(120, 16777215))
        self.IS_TaskLabel.setObjectName("IS_TaskLabel")
        self.taskHorizontalLayout.addWidget(self.IS_TaskLabel)
        self.IS_TaskComboBox = QtWidgets.QComboBox(parent=self.taskGroupBox)
        self.IS_TaskComboBox.setMinimumSize(QtCore.QSize(0, 28))
        self.IS_TaskComboBox.setMaximumSize(QtCore.QSize(16777215, 16777215))
        self.IS_TaskComboBox.setObjectName("IS_TaskComboBox")
        self.IS_TaskComboBox.addItem("")
        self.IS_TaskComboBox.addItem("")
        self.IS_TaskComboBox.addItem("")
        self.IS_TaskComboBox.addItem("")
        self.IS_TaskComboBox.addItem("")
        self.IS_TaskComboBox.addItem("")
        self.taskHorizontalLayout.addWidget(self.IS_TaskComboBox)
        spacerItem7 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.taskHorizontalLayout.addItem(spacerItem7)
        self.gridLayout_3.addWidget(self.taskGroupBox, 2, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.IS_progressBar, 3, 0, 1, 1)
        ...
        self.IS_StartImportLayout.addItem(spacerItem9)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.taskGroupBox.setTitle(_translate("MainWindow", "Task Configuration"))
        self.IS_TaskLabel.setText(_translate("MainWindow", "Task"))
        self.IS_TaskComboBox.setItemText(0, _translate("MainWindow", "Cognitiv"))
        self.IS_TaskComboBox.setItemText(1, _translate("MainWindow", "Seizure"))
        self.IS_TaskComboBox.setItemText(2, _translate("MainWindow", "Interictal"))
        self.IS_TaskComboBox.setItemText(3, _translate("MainWindow", "Stimulation"))
        self.IS_TaskComboBox.setItemText(4, _translate("MainWindow", "Sleep"))
        self.IS_TaskComboBox.setItemText(5, _translate("MainWindow", "Rest"))
