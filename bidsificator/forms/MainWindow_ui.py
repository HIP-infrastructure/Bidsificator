...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        spacerItem4 = QtWidgets.QSpacerItem(20, 80, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        ...
        spacerItem5 = QtWidgets.QSpacerItem(20, 79, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        self.gridLayout.addItem(spacerItem5, 9, 3, 1, 1)
        self.VE_TaskComboBox = QtWidgets.QComboBox(parent=self.groupBox)
        self.VE_TaskComboBox.setEnabled(False)
        self.VE_TaskComboBox.setObjectName("VE_TaskComboBox")
        self.VE_TaskComboBox.addItem("")
        self.VE_TaskComboBox.addItem("")
        self.VE_TaskComboBox.addItem("")
        self.VE_TaskComboBox.addItem("")
        self.VE_TaskComboBox.addItem("")
        self.gridLayout.addWidget(self.VE_TaskComboBox, 3, 3, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.VE_ModalityComboBox.setItemText(3, _translate("MainWindow", "T2* (anat)"))
        self.VE_ModalityComboBox.setItemText(4, _translate("MainWindow", "FLAIR (anat)"))
        self.VE_ModalityComboBox.setItemText(5, _translate("MainWindow", "CT (anat)"))
        self.VE_ModalityComboBox.setItemText(6, _translate("MainWindow", "ieeg (ieeg)"))
        self.VE_ModalityComboBox.setItemText(7, _translate("MainWindow", "photo (ieeg)"))
        self.VE_SessionLabel.setText(_translate("MainWindow", "Session :"))
        self.VE_TaskComboBox.setItemText(0, _translate("MainWindow", "Cognitiv"))
        self.VE_TaskComboBox.setItemText(1, _translate("MainWindow", "Seizure"))
        self.VE_TaskComboBox.setItemText(2, _translate("MainWindow", "Interictal"))
        self.VE_TaskComboBox.setItemText(3, _translate("MainWindow", "Stimulation"))
        self.VE_TaskComboBox.setItemText(4, _translate("MainWindow", "Sleep"))
