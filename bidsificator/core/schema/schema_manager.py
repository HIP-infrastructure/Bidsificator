...
from .models import BidsDatatype, BidsEntity
...
class BidsSchemaManager:
    ...
    def __init__(self, schema_path: Path = None):
        ...
        self.file_registry: FileExtensionRegistry | None = None
    ...
    def load_schema(self) -> None:
        ...
        try:
            ...
            raise FileNotFoundError(f"BIDS schema file not found: {self.schema_path}") from None
    ...
    def get_datatype(self, name: str) -> BidsDatatype | None:
        """Get datatype definition by name"""
        return self.datatypes.get(name)

    def get_entity(self, name: str) -> BidsEntity | None:
