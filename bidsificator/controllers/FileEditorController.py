...
class FileEditorController(QObject):
    ...
    def __init__(self, parent: Optional[QWidget] = None):
        ...
        self._current_subject_data: Optional[Dict[str, Any]] = None
        self._selected_file_index = -1
        self._edit_mode = False
        self._file_memory: Optional[Dict[str, str]] = None
    ...
    def get_selected_file_data(self) -> Optional[Dict[str, str]]:
        """
