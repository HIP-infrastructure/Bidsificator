...
from .ImportFileModel import ImportFileModel, ImportFileData
...
class ImportSessionModel:
    ...
    def get_selected_file(self) -> Optional[ImportFileData]:
        """
    ...
    def get_form_data_for_selected_file(self) -> Optional[Dict[str, str]]:
        """
