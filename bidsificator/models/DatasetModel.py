...
class DatasetModel:
    ...
    @property
    def current_dataset(self) -> DatasetInfo | None:
    ...
    def add_subject(self, subject_id: str) -> tuple[bool, str]:
        ...
        try:
            ...
            # Ensure the dataset directory structure exists (BidsFolder.__init__
            # mkdirs the root); the subject folder itself is created later by the
            # actual BIDS creation process.
            BidsFolder(self._current_dataset.path)
    ...
    def validate_dataset(self, subject_id: str | None = None) -> tuple[bool, str]:
        """
    ...
    def get_tree_model_data(self) -> str | None:
        """
