...
from bidsificator.core.schema.tsv_schema_mapper import BidsSchemaMapper
...
class TestTrcMetadataExtraction:
    ...
    def setup_method(self):
        ...
        for _i, name in enumerate(['A\'1', 'A\'2', 'B\'1']):
        ...
        # Mock triggers
        self.mock_triggers = []
        for _i, (sample, code) in enumerate([(1000, 1), (2000, 2)]):
