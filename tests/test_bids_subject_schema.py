...
def test_improved_bids_subject():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        print(
            f"✅ TRC analysis: needs_conversion={trc_analysis.needs_conversion}, "
            f"datatype={trc_analysis.bids_datatype}"
        )

        edf_analysis = subject.analyze_file(dummy_edf)
        print(
            f"✅ EDF analysis: needs_conversion={edf_analysis.needs_conversion}, "
            f"datatype={edf_analysis.bids_datatype}"
        )

        nii_analysis = subject.analyze_file(dummy_nii)
        print(
            f"✅ NII analysis: needs_conversion={nii_analysis.needs_conversion}, "
            f"datatype={nii_analysis.bids_datatype}"
        )
